...
function Habit() {
  ...
  const handleSaveHabit = (habitData: any) => {
    if (isEdit && currentHabit) {
      // 编辑现有习惯
      const updatedHabits = habits.map((h) =>
        h.id === currentHabit.id ? { ...h, ...habitData } : h,
      );
      setHabits(updatedHabits);
    } else {
      // 添加新习惯
    ...
    <div className="habit-container">
      ...
      >
        ...
        <Row gutter={[24, 24]}>
          {habits.length > 0 ? (
            habits.map((habit) => (
              <Col xs={24} sm={24} md={12} lg={8} key={habit.id}>
                <Card
                  ...
                  <div className="habit-item">
                    ...
                    <div className="habit-calculation">
                      <div className="calculation-item">
                        ...
                        <span className="calculation-value">{habit.day}天</span>
                      </div>
                      <div className="calculation-item">
